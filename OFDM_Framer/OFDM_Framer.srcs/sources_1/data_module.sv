...
module data_module #
    ...
    //assign log[2 : 0] = fdm_bus.samples_rdy;
//    assign log[5 : 3] = fdm_bus.MAX_SYMBOLS;
//    assign log[6] = bram_fifo_temp_out.fifo_valid;
//    assign log[9 : 7] = fdm_bus.samples_valid;
    
    assign s_axis_data_tready = frame_parser_bus.src_rdy;
//    assign bram_fifo_syncw_out.reverse.fifo_rdy = structs_ready && m_axis_data_tready;
//    assign bram_fifo_temp_out.reverse.fifo_rdy = structs_ready && m_axis_data_tready;
    ...
    //assign frame_parser_in_bus.forward.dst_rdy = fdm_bus.reverse.src_rdy;
...
//    assign parser_to_mod_bus.dst_rdy = 1;
