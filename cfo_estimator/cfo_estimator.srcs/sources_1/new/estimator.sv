...
module adder (
    ...
    assign adder2correction.angle[31 : 0] = (sum_real[31 : 30] == 2'b10 || sum_real[31 : 30] == 2'b01) || 
                                            (sum_imag[31 : 30] == 2'b10 || sum_imag[31 : 30] == 2'b01) ?
                                                    sum_real >>> 2 : sum_real;
    assign adder2correction.angle[63 : 32] = (sum_real[31 : 30] == 2'b10 || sum_real[31 : 30] == 2'b01) || 
                                            (sum_imag[31 : 30] == 2'b10 || sum_imag[31 : 30] == 2'b01) ?
                                                    sum_imag >>> 2 : sum_imag;                                                
    always@(posedge clk) begin
        if(~aresetn) begin
